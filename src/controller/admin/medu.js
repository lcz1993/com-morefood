...
module.exports = class extends think.cmswing.admin {
  ...
  async addAction() {
    ...
    if (this.isPost) {
      ...
      await this.hook('adminEdit', 'dish_desc', '', {$hook_key: 'dish_desc', $hook_type: '2_2_300'});
      return this.display();
    }
  }
  async editAction() {
    ...
    if (this.isPost) {
      ...
      await this.hook('adminEdit', 'dish_desc', medu.dish_desc, {$hook_key: 'dish_desc', $hook_type: '2_2_300'});
      return this.display();
    }
  }
  /**
